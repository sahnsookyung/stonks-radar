...
DATA_SOURCES = [
    ...
    ("treasury_xml_feed", "U.S. Treasury Daily Interest Rate XML Feed", "official_xml", "https://home.treasury.gov/treasury-daily-interest-rate-xml-feed", "structured_fact_only", "low"),
    ...
    ("japan_mof_jgb_csv", "Japan MOF JGB yield curve CSV", "official_csv", "https://www.mof.go.jp", "structured_fact_only", "low"),
