...
DATA_SOURCES = [
    ...
    ("treasury_xml_feed", "U.S. Treasury Daily Interest Rate XML Feed", "official_api", "https://home.treasury.gov/treasury-daily-interest-rate-xml-feed", "structured_fact_only", "low"),
    ...
    ("krx_open_api", "KRX Open API", "official_api", "https://openapi.krx.co.kr", "structured_fact_only", "medium"),
    ("data_go_kr", "Korea public-data portal market APIs", "official_api", "https://www.data.go.kr", "structured_fact_only", "medium"),
    ("yahoo_finance_delayed_quote", "Yahoo Finance delayed quote", "market_data", "https://finance.yahoo.com", "structured_fact_only", "medium"),
    ("stooq_delayed_quote", "Stooq delayed quote", "market_data", "https://stooq.com", "structured_fact_only", "medium"),
    ("japan_mof_jgb_csv", "Japan MOF JGB yield curve CSV", "official_page", "https://www.mof.go.jp", "structured_fact_only", "low"),
...
PROVIDERS = [
    ...
    ("treasury_xml_feed", "official_xml", "always_free", "FREE_ONLY", False),
    ("sec_edgar", "filing", "always_free", "FREE_ONLY", False),
    ("krx_open_api", "official_api", "always_free", "FREE_ONLY", False),
    ("data_go_kr", "official_api", "always_free", "FREE_ONLY", False),
    ("yahoo_finance_delayed_quote", "market_data", "always_free", "FREE_ONLY", False),
    ("stooq_delayed_quote", "market_data", "always_free", "FREE_ONLY", False),
    ("japan_mof_jgb_csv", "official_csv", "always_free", "FREE_ONLY", False),
