...
| OGE public disclosures | `SEC_USER_AGENT` for contact string | Undocumented public endpoint; treat as unstable and throttle to 1 request every 2 seconds | Donald Trump OGE index/PDF checks daily. No minute-level polling because Form 278-T can be delayed up to 45 days. |
