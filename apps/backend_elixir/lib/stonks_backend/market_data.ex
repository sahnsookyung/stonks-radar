defmodule StonksBackend.MarketData do
  ...
  defdelegate cache_headers(payload), to: StonksBackend.MarketData.PublicPayloads

  defdelegate license_limited_payload(symbols, start_date, end_date),
    to: StonksBackend.MarketData.PublicPayloads

  defdelegate license_limited_payload(symbols, start_date, end_date, reason),
    to: StonksBackend.MarketData.PublicPayloads
