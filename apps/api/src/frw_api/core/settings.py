...
class Settings(BaseSettings):
    ...
    gdelt_doc_min_interval_seconds: int = Field(default=6, ge=1, le=300)
    gdelt_doc_cycle_budget: int = Field(default=10, ge=0, le=250)
    gdelt_doc_incident_cycle_budget: int = Field(default=12, ge=0, le=250)
    gdelt_doc_max_records: int = Field(default=250, ge=1, le=250)
    gdelt_doc_query_pack: str = "market_watch"
    gdelt_geo_max_points: int = Field(default=1000, ge=1, le=1000)
    gdelt_bulk_max_compressed_bytes: int = Field(default=5_000_000, ge=10_000, le=25_000_000)
    gdelt_bulk_max_expanded_bytes: int = Field(default=20_000_000, ge=100_000, le=100_000_000)
    gdelt_bulk_max_rows: int = Field(default=10_000, ge=100, le=100_000)
    gdelt_bulk_max_documents: int = Field(default=500, ge=1, le=2000)
    gdelt_title_fetch_limit: int = Field(default=80, ge=0, le=500)
    gdelt_title_fetch_timeout_seconds: int = Field(default=3, ge=1, le=15)
    gdelt_title_fetch_max_bytes: int = Field(default=180_000, ge=10_000, le=1_000_000)
    gdelt_title_per_host_interval_seconds: float = Field(default=0.5, ge=0, le=30)
    breaking_area_enrichment_cycle_seconds: int = Field(default=900, ge=300, le=86400)
    breaking_map_max_points: int = Field(default=250, ge=1, le=2000)
    breaking_map_max_json_bytes: int = Field(default=250_000, ge=10_000, le=5_000_000)
