...
export function SnapshotIncidentBanner() {
  ...
  useEffect(() => {
    ...
    if (previousStatus.current === "unavailable" && current && current !== "unavailable") {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          className="focus-ring inline-flex min-h-10 items-center gap-2 rounded-md border border-current px-3 font-semibold"
